...
class Model(nn.Module):
    ...
    def forward(self, x, mask, cls_headers, question_len):
        ...
        for i in range(batches):
            ...
            y_cond_cols.append(self.cond_cols_fnn(question_encode))
...
def valid_one_sql(y_agg, y_hat_agg,
    ...
    #         ok_cond_cols = False
    #         break
    # for i in range(len(y_cond_ops)):
    #     if y_hat_cond_ops[i] < len(OP) and y_cond_ops[i] != y_hat_cond_ops[i]:
    #         ok_cond_ops = False
...
# print(tokens)
# print(input_ids)
# print(tokenizer.convert_ids_to_tokens([100, 103]))
# for i in range(1, 10):
#     print(i)
main()
